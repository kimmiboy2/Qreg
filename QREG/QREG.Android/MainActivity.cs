...
{
    [Activity(Label = "QREG", Icon = "@drawable/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
    public class MainActivity : global::Xamarin.Forms.Platform.Android.FormsAppCompatActivity
    {
        ...
        /// <summary>
        /// This below code handles the event when clicking the navigation bar back button
        /// </summary>
